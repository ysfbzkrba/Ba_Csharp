...
namespace WCA_EntityQuery.Data
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<UnitPerOrder> UnitPerOrders { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=DESKTOP-JB4FO9V\\MSSQLEXPRESS;database=Northwind;uid=sa;pwd=123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Checkout>(entity =>
            {
                ...
                entity.Property(e => e.CheckoutTotal).HasColumnName("Checkout Total");
            ...
            modelBuilder.Entity<UnitPerOrder>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Unit Per Order");
